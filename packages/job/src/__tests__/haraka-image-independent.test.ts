...
const product={id:'test-source',franchise:'Pokemon',product_type:'psa',name:'ピカチュウ(マスターボールミラー)',model_number:'025/165',price_high: 12300, price_low: 12300,image_url:'https://slab.invalid/a.jpg'};
...
test('independent explicit variant remains review-only and never becomes prepared image',()=>{
 for(const name of ['ピカチュウ(モンスターボールミラー)','ピカチュウ']){
  ...
  expect(buildTokyoPreparedCards('test',{snapshot:{store:'manman-akihabara',business_date:'2026-09-07'},products:[product]} as any,[],[row(name)])[0]).toMatchObject({image_url:null,alt_image_url:null,price_high: 12300, price_low: 12300});
 }
