...
const sheet = {
  ...
  price_snapshot_run_id: 'run-1', price_business_date: '2026-08-03', display_date: '2026-08-05', status: 'draft', revision: 0,
...
const item = {
  ...
  final_price_low: 9500, price_source: 'order_list', price_source_date: '2026-08-03', override_reason: '強化',
...
test('custom renderer passes manual display prices into the existing compositor shape', () => {
  ...
  expect(prepared.price_low).toBe(9500);
